...
module.exports = class MicrosoftNewsDataSource extends RESTDataSource {
    constructor(apiKey) {
      super();
      this.apiKey = apiKey;
      this.baseURL = 'https://api.cognitive.microsoft.com/bing/v7.0/news/';
    }
  
    willSendRequest(request) {
      request.headers.set('Ocp-Apim-Subscription-Key', this.context.token);
    }
